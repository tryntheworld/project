               ...
               <div className="p-6">
                  <div className="flex items-center">
                     <div className="flex w-10 h-10 mb-2 mr-2">
                           <img className="w-full h-full animate-bounce" src="../src/assets/multi.png"alt="" />
                     </div>
                  ...
                  <div className="pt-1 pr-0 pb-0 pl-0 mt-5 mr-0 mb-0 ml-0">
                     <div className="sm:flex sm:items-center sm:justify-between sm:space-x-5">
                        <div className="flex items-center flex-1 min-w-0">
                           <img
                              src="../src/assets/youtube.png" className="flex-shrink-0 object-cover rounded-full w-12 h-12"/>
